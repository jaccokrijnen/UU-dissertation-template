...
\begin{titlepage}
        ...
        \tikz[remember picture,overlay] \node[opacity=0.8,inner sep=0pt] at (current page.center){\includegraphics[width=1.07\paperwidth,height=1.07\paperheight]{FrontMatter/Cover/CoverBackground.png}};
